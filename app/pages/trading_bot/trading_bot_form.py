...
class TradingBotForm(FlaskForm):
    ...
    stop_loss_deviation_percentage = FloatField('Stop Loss Deviation Percentage', default=5)
    ...
    take_profit_size_percentage = FloatField('Take Profit Size Percentage', default=10)
